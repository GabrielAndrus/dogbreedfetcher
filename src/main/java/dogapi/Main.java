...
public class Main {
     ...
     */
    public static int getNumberOfSubBreeds(String breed, BreedFetcher breedFetcher) throws BreedNotFoundException{
        // TODO Task 3 implement this code so that it is entirely consistent with its provided documentation.
        // return statement included so that the starter code can compile and run.
        try {
            int subBreeds = breedFetcher.getSubBreeds(breed).size();
            return subBreeds;
